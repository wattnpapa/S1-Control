...
export const KATALOG_EINTRAEGE: readonly Katalogeintrag[] = [
  ...
  e({ typ: "AbschnittBemerkungGesetzt", form: "a", schema: S.AbschnittBemerkungGesetzt,
      ...
      klasse: "LWW_FELD" }),
  e({ typ: "AbschnittZeichenGesetzt", form: "a", schema: S.AbschnittZeichenGesetzt,
      nutzlastVersion: 1, entitaet: "abschnitt", idFeld: "abschnittId",
      feld: fest("taktischesZeichen"), klasse: "LWW_FELD" }),
