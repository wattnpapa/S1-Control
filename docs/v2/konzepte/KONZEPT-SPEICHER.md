...
**Abweichung von 02-ZIELBILD.md Nr. 10, offen für Johannes.** Die tragende Festlegung Nr. 10 lautet dort „**Archivierung** über `archiv.marker`", und das Dateilayout im Zielbild führt den Marker als Zustandsträger („Einsatz beendet"). Dieses Konzept weicht davon bewusst ab. Die Abweichung ist mit Johannes am 2026-09-08 abgestimmt, aber die verbindliche Quelle sagt weiterhin etwas anderes; 02-ZIELBILD.md Nr. 10 und das dortige Layout sind nachzuziehen. Bis dahin gilt: Diese Abweichung ist die einzige des Dokuments von den zehn tragenden Festlegungen, und sie ist hier benannt statt stillschweigend vorgenommen.
