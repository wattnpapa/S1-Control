...
Stand: 2026-09-09 · Paket M1.2, Bauvorlage für M1.3 · Status: **Entwurf, fünfundzwanzigste Fassung nach vierundzwanzig Gutachten**
...
interface Beobachtung<T> {
  ...
  undoOf?: EreignisId                       // an jeder Beobachtung, deren Ereignis eines
                                            // traegt — auch am `zweiter` und in `verdraengt`
}
...
| Ereignis nach der Archivierung wirkt, Hinweis je Entität und je Schichtplan | §7.3 | T69, T181 |
